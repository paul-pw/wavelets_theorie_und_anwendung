...
Es ergibt sich die folgende Wavelet Transformation \(\gamma(s,\tau)\)~\cite[S.5]{friendly_wavelet}
...
\[
f(t)=\int_{-\infty}^{\infty}\int_{-\infty}^{\infty}\gamma(s,\tau)\Psi_{s,\tau}(t)dsd\tau
\]
...
% wavelets-an introduction s10 Wavelet Packets
